...
export default function StatCard({ icon: Icon, label, value, accent = "primary" }) {
  return (
    <div className="bg-card rounded-xl border border-border p-4 sm:p-5 flex items-center gap-4 transition-shadow duration-200 hover:shadow-md">
      <div className={`w-11 h-11 rounded-lg flex items-center justify-center shrink-0 ${ACCENTS[accent] || ACCENTS.primary}`}>
